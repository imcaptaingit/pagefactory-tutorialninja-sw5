...
public class AccountRegisterTest extends BaseTest {
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() throws InterruptedException {
        homePage.clickOnMyQAccountTab();
        homePage.selectMyAccountOptions("Register");
        accountRegisterPage.enterFirstName("Sarvat" + getAlphaNumericString(4));
        accountRegisterPage.enterLastName("Shaikh" + getAlphaNumericString(4));
        accountRegisterPage.enterEmail("prime" + getAlphaNumericString(4) + "@gmail.com");
        accountRegisterPage.enterTelephone("9825868472");
        accountRegisterPage.enterPassword("iambossy777");
        accountRegisterPage.enterConfirmPassword("iambossy777");
